...
data <- read_csv("path/comparison/data/nan_values_custom.csv", na = "NaN")
...
write.table(round(as.matrix(d), digits = 6), file="path/nan_values_daisy.txt", row.names=FALSE, col.names=FALSE)