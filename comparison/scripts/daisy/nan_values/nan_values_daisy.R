...
data <- read_csv("/Users/bk/Documents/Zajęcia (październik - luty 2025)/Uczenie Maszynowe/gower-similarity/comparison/data/nan_values_custom.csv", na = "NaN")
...
write.table(round(as.matrix(d), digits = 6), file="/Users/bk/Documents/Zajęcia (październik - luty 2025)/Uczenie Maszynowe/gower-similarity/nan_values_daisy.txt", row.names=FALSE, col.names=FALSE)