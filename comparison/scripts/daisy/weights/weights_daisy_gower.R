...
data <- read_csv("data/files/weights_custom.csv")
...
write.table(round(as.matrix(d), digits = 6), file="comparison/scripts/daisy/weights/weights_results/weights_daisy.txt", row.names=FALSE, col.names=FALSE)