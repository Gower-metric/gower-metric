...
- Make sure that you are using the latest version.
- Read the [documentation](https://swanny0819.github.io/python-gedcom-2/python_gedcom_2/index.html) carefully and find out if the functionality is already covered, maybe by an individual configuration.
